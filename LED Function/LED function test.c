...
int main(){
	...
	Initialize();
while(1){
	if((GPIO_PORTF_DATA_R&0x11)==0x01){x=0;}         //eqv. to the default case (Press SW_1 or SW_1&2)
	else if((GPIO_PORTF_DATA_R&0x11)==0x10){x=100;}  //eqv. to reach destination case (Press SW_2)
	LED(x);
}
}
